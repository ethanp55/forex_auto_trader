...
class TrainDataUpdater:
    ...
    def update_train_data(self):
        ...
        nfp_actual, nfp_forecast, nfp_previous = self._get_new_nfp_data()
    ...
    def get_previous_nfp_data(self):
        nfp_actual, nfp_forecast, nfp_previous = self.train_data.loc[self.train_data.index[-1], ['Nonfarm_Payroll_Actual', 'Nonfarm_Payroll_Forecast', 'Nonfarm_Payroll_Previous']]

        return nfp_actual, nfp_forecast, nfp_previous
